...
public class MyosinMiniFilament extends MyosinHolder {
	...
	double untweakedMyosinfilTransGamma = 0;
	double untweakedMyosinfilPerpGamma = 0;
	double untweakedMyosinRotationalGamma = 0;
	...
	/** Probabaility that the minifilament will take a step in Z. */
	static double zPosDeltaProb = 0.0;

	/** Proabability that a minifilament will release the cortex altogether. */
	static double rdmCortexReleaseProb = 0.0;

	/** increase in diffusivity for minifilaments not bound to cortex. */
	...
	static boolean resistiveLoadOn = false;
	...
	public MyosinMiniFilament (double initX, double initY, double uVectX, double uVectY, boolean pinned) {
		super(initX,initY);

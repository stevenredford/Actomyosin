...
public class MakeActinFilamentPairs  extends Initializer
{
	int numFilaments;
	...
	public void loadParameter(String tag, AMInputStream in)  throws Exception {
		...
		if(tag.equals("NumFilaments"))  {
		...
		else if(tag.equals("XPairSpacing"))  {
			xPairSpacing = in.nextDouble();
		}
		else if(tag.equals("YPairSpacing"))  {
			yPairSpacing = in.nextDouble();
		}
		...
		else if(tag.equals("MinusAttachment"))  {
			...
			try {
				...
				System.out.println("MakeActinFilamentPairs.loadParameter: Problem loading MinusAttachment " + attach_name + ":" + e.toString());
				throw(e);
			}
		}
		else if(tag.equals("PlusAttachment"))  {
			String attach_name = "no_name";
			try {
				attach_name = in.nextString();
				Class c = Class.forName("main." + attach_name);
			...
			System.out.println("MakeActinFilamentPairs.loadParameter: Problem loading PlusAttachment " + attach_name + ":" + e.toString());
				throw(e);
			}
		}
		else throw new Exception("MakeActinFilamentPairs.loadParameter(): got bad tag = " + tag);
	}
}

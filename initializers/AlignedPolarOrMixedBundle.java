...
public class AlignedPolarOrMixedBundle  extends Initializer
{
...
Vector templates = new Vector();
	...
	class Template {
		...
		public void init() throws Exception {
			...
			int nBarbedEndsRight= (int) (Actin.numInitialActins*MiscellaneousParameters.fractionBarbedEndsRight);
			for(int i = 0; i < nBarbedEndsRight; i++){
			...
			int nBarbedEndsLeft=Actin.numInitialActins-nBarbedEndsRight;
			for(int i = 0; i < nBarbedEndsLeft; i++){

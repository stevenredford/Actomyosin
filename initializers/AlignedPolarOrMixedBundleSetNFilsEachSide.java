...
public class AlignedPolarOrMixedBundleSetNFilsEachSide  extends Initializer
{
	...
	class Template {
		...
		public void init() throws Exception {
			...
			for(int i = 0; i < MiscellaneousParameters.nBarbedEndsRight; i++){
			...
			for(int i = 0; i < MiscellaneousParameters.nBarbedEndsLeft; i++){
